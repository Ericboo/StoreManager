<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$users) {
            ...
            $id = $funcionario['id'];
            pg_query($conn, "DELETE FROM public.\"funcionario\" WHERE id = $id");
            echo "<script>alert('Funcionário retirado com sucesso!')</script>";
        }
    }
?>
    ...
    <body class="main-layout">
        ...
        <div class="mb-4 extra_wrapper style1" style="text-align: center">
            <div class="col-auto mr-auto">
                <h2 style="font-size:300%; color:lightSkyBlue">Excluir Funcionário</h2>
            </div>
        </div>
