<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$users) {
            ...
            $id = $funcionario['id'];
            $checkIds = pg_query($conn, "SELECT id FROM public.\"funcionario\" WHERE id ='$id'");
            if (pg_num_rows($checkIds) == 0) {
                pg_query($conn, "INSERT INTO public.\"funcionario\" VALUES ('$Cargo', $Admin,$id);");
    ...
    <body class="main-layout">
        ...
        <div class="mb-4 extra_wrapper style1" style="text-align: center">
            <div class="col-auto mr-auto">
                <h2 style="font-size:300%; color:lightSkyBlue">Novo Funcionário</h2>
            </div>
        </div>
        ...
        <div class="container_12">
            <div class="card-body mb-4" style="background-color: #F4F6FC;">
                <form action="" method="post">
                    ...
                    <h3>Você deve inserir o username da conta previamente criada relativa ao funcionário a ser cadastrado.</h3>
